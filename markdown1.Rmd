...
knitr::opts_chunk$set(echo = FALSE, fig.width=7, fig.height=4, fig.align="center", fig.path='Figs/', warning=FALSE, message=FALSE)
```
...
```{r plot2, echo=FALSE, fig.cap="Mean life expectancy over all years and countries in the data set, divided by continent, with standard error bars."}
...
```{r plot1, echo=FALSE, fig.cap="Individual points for life expectancy in each country and year represented in the data set, with a linear model fitted to the data."}
...
```{r plot3, echo=FALSE, fig.cap="A line is drawn for each country's life expectancy data over the years. The line's color is determined by the continent."}
...
```{r continentMeangdp, echo=FALSE, fig.cap="Mean gdp of all countires and years in the data set, divided by country."}
